...
--
-- Hôte : localhost:3306
-- Généré le : lun. 25 mai 2026 à 12:22
...
(52, 1107, 'Lor', 'Philippe', '116 rue de Javel', '75015', 'Paris', 'France', '+33644982807', '', NULL, 'livraison', '2026-05-18 02:31:17'),
(53, 1107, 'Lor', 'Philippe', '116 rue de Javel', '75015', 'Paris', 'France', '0644982807', NULL, NULL, 'livraison', '2026-05-25 09:32:42'),
(54, 1107, 'Lor', 'Philippe', '116 rue de Javel', '75015', 'Paris', 'France', '0644982807', NULL, NULL, 'livraison', '2026-05-25 12:16:33'),
(55, 1107, 'Lor', 'Philippe', '116 rue de Javel', '75015', 'Paris', 'France', '0644982807', NULL, NULL, 'livraison', '2026-05-25 12:17:15');
...
(1107, 'lhpp.philippe@gmail.com', '$2y$10$5vojxKrIfZrONXpgKMEBUeM9EUCgWPBU0/6C9nNrlPm.l1yUJyMb.', 'Lor', 'Philippe', '0644982807', 0, NULL, NULL, 'permanent', '2026-05-18 02:30:49', 'skcpvf8mq9a2sh0pmfhvno6062'),
(1130, 'wongfeyhong45@gmail.com', '$2y$10$v5/IQnvpUPla5C5QNHmkmewozN41L19W5YHSzLXPDp9RviJ2V59gO', 'Client', '', '', 0, NULL, NULL, 'permanent', '2026-05-24 08:08:53', NULL),
(1132, 'temp_6a12cafb2c700@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-24 09:55:07', '3e7424s7oajptek7utu5ietqmq'),
(1133, 'temp_6a12d30175bef@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-24 10:29:21', 'l4rv3i5p8d0unb36cg99proprt'),
(1134, 'temp_6a12d30194b5b@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-24 10:29:21', 'ehm4vndp60bsomg8d88iohus49'),
(1135, 'temp_6a12d301c8e80@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-24 10:29:21', 'k8hir0ts0nk9t8f0i44g84rtri'),
(1139, 'temp_6a14067ff0d73@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-25 08:21:19', 'f5rs1bn6b9ooqgjnaesgg6aaga'),
(1142, 'temp_6a140df722238@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-25 08:53:11', 'u93elpfi9jupjd1nm3ag1h04ng'),
(1143, 'temp_6a140ed3171bd@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-25 08:56:51', 'akh2lmu9n7vcfgkghgu3jua9ns'),
(1145, 'temp_6a1410cb7b525@YoukiAndCo.fr', NULL, 'Invité', 'Client', NULL, 0, NULL, NULL, 'temporaire', '2026-05-25 09:05:15', 'ja255f9t4ne9mv13l389qhh3lr');
...
(180, 1107, 52, 52, '2026-05-18 02:31:17', 'PayPal', '2026-05-23', 0, 19, 'payee', 'en_attente', NULL);
...
(163, 180, '19.00', 'EUR', 'payee', 'PayPal', NULL, '2026-05-18 02:32:09', '2026-05-18 02:32:09');
...
(252, 1107, '2026-05-25 09:03:22'),
(268, 1130, '2026-05-25 07:30:26');
...
(238, '460c64a06e8a01126e3c9cfe237bdd5df47316a5d8ee6ad8e5b01571ff0bceb8', 'lhpp.philippe@gmail.com', 1107, '2026-05-25 12:30:45', 1);
...
--
ALTER TABLE `Adresse`
  MODIFY `idAdresse` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `Client`
  MODIFY `idClient` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1151;
...
--
ALTER TABLE `Commande`
  MODIFY `idCommande` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;

--
-- AUTO_INCREMENT pour la table `LigneCommande`
--
ALTER TABLE `LigneCommande`
  MODIFY `idLigneCommande` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=244;

--
-- AUTO_INCREMENT pour la table `LignePanier`
--
ALTER TABLE `LignePanier`
  MODIFY `idLignePanier` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=681;
...
--
ALTER TABLE `Paiement`
  MODIFY `idPaiement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;

--
-- AUTO_INCREMENT pour la table `Panier`
--
ALTER TABLE `Panier`
  MODIFY `idPanier` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=279;
