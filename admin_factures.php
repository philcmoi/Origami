    ...
    <body>
        <div class='container'>
            ...
            <div class='header-actions'>
                <a href='admin_factures.php' class='btn-retour'>
                    <span style='font-size: 16px;'>⬅️</span>
                    Retour à l'administration des factures
                </a>
            </div>
        ...
        <script>
            // Ajout d'un raccourci clavier pour le retour (Échap)
            document.addEventListener('keydown', function(e) {
                if (e.key === 'Escape') {
                    window.location.href = 'admin_factures.php';
                }
            });
            
            // Message pour informer de la touche Échap
            console.log('💡 Astuce: Appuyez sur la touche Échap pour retourner rapidement à l\\'administration');
        </script>
    </body>
    </html>
    ";
