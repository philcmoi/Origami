...
<head>
    ...
    <style>
        * {
        ...
        /* Recent Orders avec scroll horizontal */
        .recent-orders {
            background-color: white;
            border-radius: 12px;
            padding: 30px;
...
<body>
    <div class="container">
        ...
        <!-- Commandes récentes avec scroll horizontal -->
            ...
            <div class="table-wrapper">
                <table class="orders-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>#<?php echo $commande['idCommande']; ?></strong></td>
                            ...
                            <td style="font-size: 12px; color: #666;"><?php echo htmlspecialchars($commande['email']); ?></td>
